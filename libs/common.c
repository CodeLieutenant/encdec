...
int32_t
bin2hex(char* const dst, const uint32_t dst_len, const byte* const src, const uint32_t src_len)
{
	int32_t i, j;
...
uint32_t
hexdump(const FILE* const output, const char* const hex)
{
...
#ifndef _MSC_VER
int32_t
stricmp(const char* const p1, const char* const p2)
{
